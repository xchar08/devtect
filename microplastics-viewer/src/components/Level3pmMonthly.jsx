...
function Level3pmMonthly() {
    ...
    Papa.parse('/Level3pmR1.csv', {
      ...
      complete: (results) => {
        ...
        const cleaned = results.data.filter((row) => {
          ...
          // We'll check monthly on the fly
          return true
        })
        setRawData(cleaned)
  ...
  return (
    <div className="bg-white p-4 rounded shadow mt-4">
      <h2 className="text-xl font-semibold mb-2">Level3pmR1 - Monthly Heatmap</h2>
          ...
          {rawData.map((row, i) => {
            ...
            return (
              ...
              >
                <Tooltip>
                  <div>
                    <strong>{month}:</strong> {val.toFixed(1)}<br/>
                    Lat: {lat}, Lon: {lon}
                  </div>
                </Tooltip>
              </CircleMarker>
...
export default Level3pmMonthly
